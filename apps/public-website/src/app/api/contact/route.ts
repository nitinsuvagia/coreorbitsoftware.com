  ...
  try {
    ...
    const htmlBody = `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        <h2 style="color: #4910bc;">New Contact Form Submission</h2>
        <table style="width: 100%; border-collapse: collapse; margin-top: 16px;">
          ...
          <tr><td style="padding: 8px 12px; font-weight: bold; border-bottom: 1px solid #eee;">Subject</td><td style="padding: 8px 12px; border-bottom: 1px solid #eee;">${escapeHtml(subjectLabel)}</td></tr>
        </table>
        ...
        <p style="margin-top: 20px; font-size: 12px; color: #999;">This message was sent from the CoreOrbit website contact form.</p>
      </div>
    `;
    ...
    const res = await fetch(`${NOTIFICATION_SERVICE_URL}/api/notifications/platform/email`, {
      ...
      body: JSON.stringify({
        to: 'itsupport@coreorbitsoftware.com',
