# Security Groups for Office Management SaaS
...
resource "aws_security_group" "ecs_instances" {
  ...
  # Allow traffic between ECS instances (for service discovery)
  ingress {
    description = "Traffic from ECS instances"
    from_port   = 0
    to_port     = 65535
    protocol    = "tcp"
    self        = true
