-- ============================================================================
-- Add missing tables: employee_skills, badges, employee_badges
-- Add missing column: performance_reviews.review_type
-- ============================================================================
...
-- 3. Employee badge assignments table
...
-- 4. Add review_type column to performance_reviews (if it doesn't exist)
DO $$ BEGIN
    ALTER TABLE performance_reviews ADD COLUMN review_type VARCHAR(50) NOT NULL DEFAULT 'periodic';
EXCEPTION WHEN duplicate_column THEN null;
END $$;

-- 5. Add unique constraint for performance_reviews upsert (if it doesn't exist)
DO $$ BEGIN
