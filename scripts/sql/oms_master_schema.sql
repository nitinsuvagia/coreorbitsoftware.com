-- ============================================================================
-- OMS MASTER DATABASE SCHEMA
-- ============================================================================
-- This file contains the complete schema for the master/platform database.
-- It is used for initial setup on production servers.
-- 
-- Usage: 
--   psql -U postgres -d oms_master -f oms_master_schema.sql
--
...
ALTER TABLE "platform_admins" ADD CONSTRAINT "platform_admins_invited_by_fkey" 
    FOREIGN KEY ("invited_by") REFERENCES "platform_admins"("id") ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE "platform_admin_sessions" ADD CONSTRAINT "platform_admin_sessions_admin_id_fkey" 
    FOREIGN KEY ("admin_id") REFERENCES "platform_admins"("id") ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE "platform_login_history" ADD CONSTRAINT "platform_login_history_admin_id_fkey" 
    FOREIGN KEY ("admin_id") REFERENCES "platform_admins"("id") ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE "trusted_devices" ADD CONSTRAINT "trusted_devices_admin_id_fkey" 
    FOREIGN KEY ("admin_id") REFERENCES "platform_admins"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE "tenant_subdomains" ADD CONSTRAINT "tenant_subdomains_tenant_id_fkey" 
    FOREIGN KEY ("tenant_id") REFERENCES "tenants"("id") ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE "custom_domains" ADD CONSTRAINT "custom_domains_tenant_id_fkey" 
    FOREIGN KEY ("tenant_id") REFERENCES "tenants"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE "usage_records" ADD CONSTRAINT "usage_records_tenant_id_fkey" 
    FOREIGN KEY ("tenant_id") REFERENCES "tenants"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE "payment_methods" ADD CONSTRAINT "payment_methods_subscription_id_fkey" 
...
ALTER TABLE "platform_audit_logs" ADD CONSTRAINT "platform_audit_logs_admin_id_fkey" 
    FOREIGN KEY ("admin_id") REFERENCES "platform_admins"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
VALUES 
    (gen_random_uuid()::varchar, 'initial_schema', '20260115063011_add_platform_settings_table', NOW(), 1),
    (gen_random_uuid()::varchar, 'add_report_logo', '20260305120000_add_tenant_report_logo', NOW(), 1);

-- ============================================================================
-- SCHEMA VERSION
-- ============================================================================

COMMENT ON DATABASE oms_master IS 'OMS Master Database - Schema Version 2026.03.05';
